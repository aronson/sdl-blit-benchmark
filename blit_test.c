...
const uint32_t scalar_result[4] = {0xb300df09, 0xb81c0646, 0xd5faeb50, 0x7897fc07};
...
int testRandomToRandomSVGAMultipleIterations() {
    ...
    const int passes_scalar = out[0] == scalar_result[0] && out[1] == scalar_result[1] &&
                                   out[2] == scalar_result[2] && out[3] == scalar_result[3];
    const int passes_arm_simd = out[0] == arm_simd_result[0] && out[1] == arm_simd_result[1] &&
                                   out[2] == arm_simd_result[2] && out[3] == arm_simd_result[3];
    return passes_x86_simd || passes_scalar || passes_arm_simd;
}
